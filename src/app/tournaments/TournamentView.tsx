                  ...
                  <span
                    className={`px-2 py-0.5 rounded-md font-bold uppercase tracking-wider text-[10px] ${
                      fixture.stage === "Final"
                        ...
                        : fixture.stage === "3rd Place Playoff"
                ...
                <div className="space-y-2 py-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-white ${
                          fixture.team1.includes("Tigers")
                            ? "bg-emerald-600"
                            : fixture.team1.includes("VPGR")
                            ? "bg-purple-600"
                            : fixture.team1.includes("Dabanggs")
                            ? "bg-amber-600"
                            : "bg-blue-600"
                        }`}
                      >
                      ...
                      >
                        {fixture.team1} {fixture.winner1 && "(W)"}
                      </span>
                    </div>
                    <span
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-white ${
                          fixture.team2.includes("Tigers")
                            ? "bg-emerald-600"
                            : fixture.team2.includes("VPGR")
                            ? "bg-purple-600"
                            : fixture.team2.includes("Dabanggs")
                            ? "bg-amber-600"
                            : "bg-blue-600"
                        }`}
                      >
                      ...
                      >
                        {fixture.team2} {fixture.winner2 && "(W)"}
                      </span>
                    </div>
                    <span
                      className={`font-mono text-sm font-bold ${
